...
/*   Updated: 2025/10/19 18:19:06 by scarlucc         ###   ########.fr       */
/*                                                                            */
/******************************************************************************/
...
int create_serv_pocket(int port)
{
	...
	SO_REUSEADDR == option_name : impostazione (specifica) da cambiare. Permette di riutilizzare la stessa porta
	opt == option_value
	sizeof() == */
    int opt = 1;//1 == acceso, 0 == spento
    ...
    std::memset(&addr, 0, sizeof(addr)); //pulizia dati
    addr.sin_family = AF_INET; 			//usero' ipv4
